    ...
    <div class="row">
        <div class="col-md-6 col-lg-4 mx-auto">
                <div class="card card-body">
                    <h3 class="text-center mb-4">Ingres&aacute</h3>
                    <form action="./database/login.php" method="post">
                      ...
                      <span class="font-weight-bold">Usuario / Telefono movil</span><div class="form-group">
                        ...
                        <span  class="font-weight-bold">Contraseña </span> <span ><a  href="forgot-pass.php">¿Olvidaste la contraseña?</a></span><div class="form-group">
                            <input class="form-control input-lg" name="password" type="password" pattern=".{6,}">
                        </div>
                        <span class="ingresa"><input type="checkbox"> ¿Mantenerme conectado?
                          ...
                          title="Manteneme conectado" data-placement="top" data-content="<span>Para mantener tu cuenta segura, usa esta opcion <b>solo en tu dispositivo personal  <b/></span>" >Detalles <i class="fa fa-angle-down"></i></a></span><br><br>
                             <script>
                                $(function () {
